...
import {villaWithData} from "./data";


const Villa = () => {
    const [villas, setVillas] = useState(villaWithData);
    const handleFlatInputChange = (villaIndex, flatIndex, columnIndex, newValue) => {
        ...
        // setData("villaWithData", updatedVillas)
    };
    ...
    const addNewItem = (villaIndex) => {
        ...
        setVillas(newVillas);
        // setData("villaWithData", newVillas)
    };
    ...
    return (
        <div className='container'>
            <Navbar/>
            <Calculate page={"villa"} title={"villa_with"} isTotalInvalid={true} autoMulti={true} list={calculationData()}/>
