...
import {withoutData} from "./data";
import {v4 as uuidv4} from "uuid";
import Calculate from "../../components/calculate";
import MagicInput from "../../components/Input";

const Without = () => {
    const [categories, setCategories] = useState(withoutData);
    ...
    //     setData("categoryData", updatedCategories)
    // };
    ...
    const addNewItem = (categoryIndex) => {
        ...
        // setData("categoryData", newCategories)
    };
    ...
    return (
        <div className='container'>
            <Navbar/>
            <Calculate page={"without"} title={"without"} addCopy={true} autoMulti={true} list={calculationData()}/>
                        ...
                        {category.flats.map((flat, flatIndex) =>
                            <div className="div-input-style-without" key={flatIndex}>
                                ...
                                <div className="grid-div-without">
                                    ...
                                    <button className="image-button-without">
                                        <img
                                            src={image_drash}
                                            alt="Button Icon"
                                            onClick={() => {
